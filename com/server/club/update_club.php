...
include("dbconnection.php");
	...
	//this query updates the values into the admin_login table
	$query = "UPDATE admin_login SET club_name='$club_name', club_password='$club_password', club_bio='$club_bio' WHERE club_name='$original_club_name'";
